		...
		<div className='bg-black min-h-screen text-white'>
			...
			<div className='container mx-auto px-4 py-8 mt-16'>
				...
				<form className='flex gap-2 items-stretch mb-8 max-w-2xl mx-auto' onSubmit={handleSearch}>
					...
					/>
					<button className='bg-red-600 hover:bg-red-700 text-white p-2 rounded transition-all duration-300'>
				...
				<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
					{results.map((result) => {
						...
						return (
							<div key={result.id} className='bg-gray-800 p-4 scale-95 rounded transition-all duration-300 ease-out animate-fade-in'>
								{activeTab === "person" ? (
